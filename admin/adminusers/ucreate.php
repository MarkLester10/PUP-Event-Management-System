    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-content">
            <div class="button-group">
                <a href="ucreate.php" class="btn add act-add"><i class="fa fa-check-circle"> Add User</i></a>
            ...
            <div class="content user">
                ...
                <form action="ucreate.php" method="POST" class="form">
                    <span>
                        <h4>Username</h4> <input type="text" name="username" value="<?php echo $username; ?>" />
                    </span>
                    <span class="validationEmail">
                        <h4>Email</h4><input type="email" id="email" name="email" onkeyup="checkEmail();"
                    ...
                    <span class="button">
                        <button type="submit" name="create-admin" class="btn a"><i class="fa fa-check-circle"> Create
                                User</i></button>
                    </span>
                </form>
            </div>
