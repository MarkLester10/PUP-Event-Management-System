    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-content">
            <div class="button-group">
                <a href="ecreate.php" class="btn add act-add"><i class="fa fa-check-circle"> Add
                        Event</i></a>
            ...
            <div class="content">
                ...
                <form action="ecreate.php" method="POST" enctype="multipart/form-data">
                    <div class="utilities">
                        <button type="reset" onclick="clear();">Clear</button>
                        <button type="button"><a
                                href="<?php echo BASE_URL . '/admin/dashboard.php'; ?> ">Cancel</a></button>
                    </div>
                    <div class="validation">
                        <h4>Title</h4>
                        <input id="title" type="text" name="title" value="<?php echo $title; ?>" onkeyup="
                            checkTitle();">
                        <span id="text"></span>
                    </div>
                    <div>
                    ...
                    <div>
                        <button type="submit" name="add-event" class="btn a add-event"><i class=" fa fa-check-circle">
                                Add
                                Event</i></button>
                    </div>
                </form>
